 ...
 * @var \App\Model\Entity\Civility[]|\Cake\Collection\CollectionInterface $civility
 */
?>
...
<div class="civility index large-9 medium-8 columns content">
    <h3><?= __('Civility') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($civility as $civility): ?>
            <tr>
